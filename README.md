...
**Stack:** Supabase (database, live) · self-hosted n8n (orchestration/bot logic, not yet hosted) · Retool free tier (admin visibility, not yet built) · Meta WhatsApp Cloud API, direct · OpenAI API (conversation engine)
